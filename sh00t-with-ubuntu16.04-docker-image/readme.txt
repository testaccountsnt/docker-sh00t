...
cd /path/of/sh00t-with-ubuntu16.04-docker-image
docker build -t sh00t:ubuntu .
### or run build with path of directory sh00t-with-ubuntu16.04-docker-image
docker build -t sh00t:ubuntu /path/of/sh00t-with-ubuntu16.04-docker-image
